...
export default function Banner() {
    ...
    const nextImagesIndex = activeIndex === images.length - 1 ? 0 : activeIndex + 1

    return (
        <div className="slider">
        <div className="sliderImg sliderImagePrev">
            {images[prevImageIndex]}
        </div>
        <div className="sliderImg sliderImage">
            {images[activeIndex]}
        </div>
        <div className="sliderImg sliderImageNext">
            {images[nextImagesIndex]}
        </div>
        </div>
    )
}